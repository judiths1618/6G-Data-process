...
datasets = {
    # "WebTraffic": "WebTrafficLAcity/lacity.org-website-traffic.csv",
            # "RossmanSales": "RossmanSales/train.csv",
            "AustraliaTourism": f"{datasetfolder}AustraliaTourism/tourism.csv",
            "MetroTraffic": f"{datasetfolder}MetroTraffic/Metro_Interstate_Traffic_Volume.csv",
            "BeijingAirQuality": f"{datasetfolder}BeijingAirQuality/beijing+multi+site+air+quality+data/data.csv",
            "PanamaEnergy": f"{datasetfolder}PanamaEnergy/continuous dataset.csv",
            # "EUR": f"{datasetfolder}EUR/splits/amf-perfromance"
            }
